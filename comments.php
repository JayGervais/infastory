	<?php 
	$post_data_query = mysqli_query($con, "SELECT * FROM messages WHERE id='$id'");
	...
	<form action="post-comments.php?id=<?php echo $post_id; ?>" id="comment_form" name="postComment<?php echo $post_id; ?>" method="POST">
