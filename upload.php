...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/socialclub/assets/images/profile_pics';
	//Set File name	
...
if (isset($_POST['x'])){
	...
	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){	
		...
		//save the new cropped version
			imagejpeg($dst_r, "assets/users/" . $userLoggedIn . "/profile_pics/".$finalname."n.jpeg", 90); 	
		...
		$result_path ="assets/users/" . $userLoggedIn . "/profile_pics/".$finalname."n.jpeg";
...
?>
<div id="Overlay" style=" width:100%; height:100%; border:0px; position:absolute; top:0px; left:0px; z-index:2000; display:none;"></div>
<div class="main_column column">
	...
	<div id="formExample">
	    ...
	    <form action="upload.php" method="post"  enctype="multipart/form-data">
	        ...
	        <input type="file" id="image" name="image" style="width:100%; height:30px; " /><br /><br />
	        <input type="submit" value="Submit" style="width:95px; height:25px;" />
	    </form><br /><br />
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
	    ...
	    <div id="CroppingContainer" style="width:100%; max-height:600px; background-color:#FFF; position:relative; z-index:2001;">  
	        ...
	        <div id="InfoArea" style="width:180px; height:100%; position:relative; margin:40px 0px 0px 40px; border:0px #666 solid; float:left;">	
	        ...
	        <div id="CropImageForm2" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="upload.php" method="post" onsubmit="return cancelCrop();">
	                <input type="submit" value="Cancel Crop" style="width:125px; height:30px;"   />
	            </form>
	        </div>            
